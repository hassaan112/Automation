...
slightly larger numbers than needed, the actual size of the canvas on which the targets can appear is 500x300. You can 
tweak these numbers in lines 41, 42, 43, and 44.
'''
